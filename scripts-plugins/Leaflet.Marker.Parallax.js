L.Marker.Parallax = L.Marker.extend({
    ...
    _onZoomStart : function(e){
        ...
        map.on('zoomend', function(){ 
            //console.log('@ zoomend', tempLatLng, origLatLng);
            this.options.parallaxZoffset = origParallaxZoffset; this.setLatLng(origLatLng); this._onMapMove(); 
